(module
 ...
 (data (i32.const 1200) "account already exist\00")
 ...
 (data (i32.const 1520) "from account does not exist\00")
 (data (i32.const 1552) "there is no staked amount\00")
 (data (i32.const 1584) "unstake amount overdue\00")
 (data (i32.const 1616) "invalid supply\00")
 (data (i32.const 1632) "max-supply must be positive\00")
 (data (i32.const 1664) "token with symbol already exists\00")
 (data (i32.const 1712) "token with symbol does not exist, create token before issue\00")
 (data (i32.const 1776) "must issue positive quantity\00")
 (data (i32.const 1808) "quantity exceeds available supply\00")
 (data (i32.const 1856) "active\00")
 (data (i32.const 1872) "send lockup is enabled\00")
 (data (i32.const 1904) "send lock is enable\00")
 ...
 (data (i32.const 2112) "lock account does not exist\00")
 (data (i32.const 2144) "lock account already exists in the table\00")
 (data (i32.const 2192) "unlock account does not exist\00")
 (data (i32.const 2224) "there is no matched unlock account in the table\00")
