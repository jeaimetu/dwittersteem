(module
 ...
 (import "env" "_ZN5eosio5token7unstakeEybybNS_5assetE" (func $_ZN5eosio5token7unstakeEybybNS_5assetE (param i32 i64 i32 i64 i32 i32)))
 (import "env" "_ZN5eosio5token5stakeEybybNS_5assetE" (func $_ZN5eosio5token5stakeEybybNS_5assetE (param i32 i64 i32 i64 i32 i32)))
 (table 11 11 anyfunc)
 (elem (i32.const 0) $__wasm_nullptr $_ZN5eosio5token8transferEyyNS_5assetENSt3__112basic_stringIcNS2_11char_traitsIcEENS2_9allocatorIcEEEE $_ZN5eosio5token6createEyNS_5assetE $_ZN5eosio5token10newaccountEy $__importThunk__ZN5eosio5token7unstakeEybybNS_5assetE $_ZN5eosio5token11pubtransferEybybNS_5assetENSt3__112basic_stringIcNS2_11char_traitsIcEENS2_9allocatorIcEEEE $__importThunk__ZN5eosio5token5stakeEybybNS_5assetE $_ZN5eosio5token5checkEyyNSt3__112basic_stringIcNS1_11char_traitsIcEENS1_9allocatorIcEEEE $_ZN5eosio5token5issueEyNS_5assetENSt3__112basic_stringIcNS2_11char_traitsIcEENS2_9allocatorIcEEEE $_ZN5eosio5token4lockEym $_ZN5eosio5token6unlockEy)
 (memory $0 1)
 ...
 (data (i32.const 528) "send lockup is enabled\00")
 (data (i32.const 560) "send lock is enable\00")
 (data (i32.const 592) "comparison of assets with different symbols is not allowed\00")
 (data (i32.const 656) "multiplication overflow\00")
 (data (i32.const 688) "multiplication underflow\00")
 (data (i32.const 720) "divide by zero\00")
 (data (i32.const 736) "signed division overflow\00")
 ...
 (data (i32.const 1056) "symbol precision mismatch\00")
 (data (i32.const 1088) "memo has more than 256 bytes\00")
 ...
 (data (i32.const 1408) "account does not exist\00")
 (data (i32.const 1440) "invalid supply\00")
 (data (i32.const 1456) "max-supply must be positive\00")
 (data (i32.const 1488) "token with symbol already exists\00")
 (data (i32.const 1536) "token with symbol does not exist, create token before issue\00")
 (data (i32.const 1600) "must issue positive quantity\00")
 (data (i32.const 1632) "quantity exceeds available supply\00")
 ...
 (func $__importThunk__ZN5eosio5token7unstakeEybybNS_5assetE (type $FUNCSIG$vijijii) (param $0 i32) (param $1 i64) (param $2 i32) (param $3 i64) (param $4 i32) (param $5 i32)
  (call $_ZN5eosio5token7unstakeEybybNS_5assetE
   (get_local $0)
   (get_local $1)
   (get_local $2)
   (get_local $3)
 ...
 (func $__importThunk__ZN5eosio5token5stakeEybybNS_5assetE (type $FUNCSIG$vijijii) (param $0 i32) (param $1 i64) (param $2 i32) (param $3 i64) (param $4 i32) (param $5 i32)
  (call $_ZN5eosio5token5stakeEybybNS_5assetE
   (get_local $0)
   (get_local $1)
   (get_local $2)
   (get_local $3)
