(module
 ...
 (table 10 10 anyfunc)
 (elem (i32.const 0) $__wasm_nullptr $_ZN5eosio5token6createEyNS_5assetE $_ZN5eosio5token10newaccountEy $_ZN5eosio5token5checkEyyNSt3__112basic_stringIcNS1_11char_traitsIcEENS1_9allocatorIcEEEE $_ZN5eosio5token8transferEyyNS_5assetENSt3__112basic_stringIcNS2_11char_traitsIcEENS2_9allocatorIcEEEE $_ZN5eosio5token9itransferEyyNS_5assetENSt3__112basic_stringIcNS2_11char_traitsIcEENS2_9allocatorIcEEEE $_ZN5eosio5token5issueEyNS_5assetENSt3__112basic_stringIcNS2_11char_traitsIcEENS2_9allocatorIcEEEE $_ZN5eosio5token4lockEym $_ZN5eosio5token6unlockEy $_ZN5eosio5token11pubtransferEybybNS_5assetENSt3__112basic_stringIcNS2_11char_traitsIcEENS2_9allocatorIcEEEE)
 (memory $0 1)
 ...
 (data (i32.const 112) "account already exist\00")
 ...
 (data (i32.const 384) "from account does not exist\00")
 (data (i32.const 416) "to account does not exist\00")
 (data (i32.const 448) "eoscafekorea\00")
 (data (i32.const 464) "cannot transfer to self\00")
 (data (i32.const 496) "unable to find key\00")
 (data (i32.const 528) "invalid quantity\00")
 (data (i32.const 560) "must transfer positive quantity\00")
 ...
 (data (i32.const 1168) "account does not exist\00")
 (data (i32.const 1200) "stake from account already exists\00")
 (data (i32.const 1248) "cannot increment end iterator\00")
 (data (i32.const 1280) "stake to account already exists\00")
 (data (i32.const 1312) "invalid supply\00")
 (data (i32.const 1328) "max-supply must be positive\00")
 (data (i32.const 1360) "token with symbol already exists\00")
 (data (i32.const 1408) "token with symbol does not exist, create token before issue\00")
 (data (i32.const 1472) "must issue positive quantity\00")
 (data (i32.const 1504) "quantity exceeds available supply\00")
 (data (i32.const 1552) "active\00")
 (data (i32.const 1568) "send lockup is enabled\00")
 (data (i32.const 1600) "send lock is enable\00")
 (data (i32.const 1632) "comparison of assets with different symbols is not allowed\00")
 (data (i32.const 1696) "multiplication overflow\00")
 (data (i32.const 1728) "multiplication underflow\00")
 (data (i32.const 1760) "divide by zero\00")
 (data (i32.const 1776) "signed division overflow\00")
 (data (i32.const 1808) "lock account does not exist\00")
 (data (i32.const 1840) "lock account already exists in the table\00")
 (data (i32.const 1888) "unlock account does not exist\00")
 (data (i32.const 1920) "there is no matched unlock account in the table\00")
 (data (i32.const 1968) "cannot pass end iterator to erase\00")
 (data (i32.const 2016) "object passed to erase is not in multi_index\00")
 (data (i32.const 2064) "cannot erase objects in table of another contract\00")
 (data (i32.const 2128) "attempt to remove object that was not in multi_index\00")
 ...
 (func $_ZN5eosio5token10newaccountEy (type $FUNCSIG$vij) (param $0 i32) (param $1 i64)
  ...
  (call $_ZZN5eosio11multi_indexILy12578434754291957760ENS_5token9pub_tableEJEE7emplaceIZNS1_10newaccountEyE3$_0EENS3_14const_iteratorEyOT_ENKUlRS7_E_clINS3_4itemEEEDaS9_
   (i32.add
    (get_local $7)
    (i32.const 64)
   )
 ...
 (func $_ZZN5eosio11multi_indexILy12578434754291957760ENS_5token9pub_tableEJEE7emplaceIZNS1_10newaccountEyE3$_0EENS3_14const_iteratorEyOT_ENKUlRS7_E_clINS3_4itemEEEDaS9_ (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i64)
 ...
 (func $_ZN5eosio5token5stakeEybybNS_5assetE (param $0 i32) (param $1 i64) (param $2 i32) (param $3 i64) (param $4 i32) (param $5 i32)
  (local $6 i64)
  (local $7 i32)
  (local $8 i32)
  (local $9 i64)
