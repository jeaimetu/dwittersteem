(module
 ...
 (table 7 7 anyfunc)
 (elem (i32.const 0) $__wasm_nullptr $_ZN5eosio5token7unstakeEyyNS_5assetE $_ZN5eosio5token5checkEyNSt3__112basic_stringIcNS1_11char_traitsIcEENS1_9allocatorIcEEEE $_ZN5eosio5token4saveEyNS_5assetE $_ZN5eosio5token5stakeEyyNS_5assetE $_ZN5eosio5token6updateEy $_ZN5eosio5token4drawEyNS_5assetE)
 (memory $0 1)
 (data (i32.const 4) "\c0d\00\00")
 (data (i32.const 16) "no balance object found\00")
 (data (i32.const 48) "overdrawn balance\00")
 (data (i32.const 80) "object passed to modify is not in multi_index\00")
 (data (i32.const 128) "cannot modify objects in table of another contract\00")
 (data (i32.const 192) "attempt to subtract asset with different symbol\00")
 (data (i32.const 240) "subtraction underflow\00")
 (data (i32.const 272) "subtraction overflow\00")
