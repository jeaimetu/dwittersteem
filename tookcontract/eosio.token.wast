(module
 ...
 (data (i32.const 624) "TOOK\00")
 (data (i32.const 640) "taketooktook\00")
 (data (i32.const 656) "link internal account to external account\00")
 (data (i32.const 704) "cannot transfer to self\00")
 (data (i32.const 736) "to account does not exist\00")
 ...
 (data (i32.const 896) "memo has more than 256 bytes\00")
 ...
 (data (i32.const 1040) "no balance object found\00")
 (data (i32.const 1072) "overdrawn balance\00")
 (data (i32.const 1104) "attempt to subtract asset with different symbol\00")
 (data (i32.const 1152) "subtraction underflow\00")
 (data (i32.const 1184) "subtraction overflow\00")
 ...
 (data (i32.const 1392) "invalid supply\00")
 (data (i32.const 1408) "max-supply must be positive\00")
 (data (i32.const 1440) "token with symbol already exists\00")
 (data (i32.const 1488) "token with symbol does not exist, create token before issue\00")
 (data (i32.const 1552) "must issue positive quantity\00")
 (data (i32.const 1584) "quantity exceeds available supply\00")
 (data (i32.const 1632) "active\00")
 (data (i32.const 1648) "newdexpocket\00")
 (data (i32.const 1664) "You can not transfer to Newdex in a certain period\00")
 (data (i32.const 1728) "whaleextrust\00")
 (data (i32.const 1744) "You can not transfer to this exchange in a certain period\00")
 (data (i32.const 1808) "heydcmjrhege\00")
 (data (i32.const 1824) "eosbtexbonus\00")
 (data (i32.const 1840) "eosconvertbt\00")
 (data (i32.const 1856) "eosbtexteams\00")
 (data (i32.const 1872) "btexexchange\00")
 (data (i32.const 1888) "eosbtextoken\00")
 (data (i32.const 1904) "eosbtexfunds\00")
 (data (i32.const 1920) "locktooktook\00")
 (data (i32.const 1936) "goodtooktook\00")
 (data (i32.const 1952) "From acocunt is locked, ask tooktook admin\00")
 (data (i32.const 2000) "To cocunt is locked, ask tooktook admin\00")
 (data (i32.const 2048) "get\00")
 (data (i32.const 2064) "lock account does not exist\00")
 (data (i32.const 2096) "lock account already exists in the table\00")
 (data (i32.const 2144) "unlock account does not exist\00")
 (data (i32.const 2176) "there is no matched unlock account in the table\00")
 (data (i32.const 2224) "cannot pass end iterator to erase\00")
 (data (i32.const 2272) "cannot increment end iterator\00")
 (data (i32.const 2304) "nothing to delete\00")
 (data (i32.const 2336) "\"\"\00")
 (data (i32.const 2352) "account already exist\00")
 (data (i32.const 2384) "from account does not exist\00")
 (data (i32.const 2416) "stake event\00")
 (data (i32.const 2432) "there is no staked amount to unstake\00")
 (data (i32.const 2480) "unstake amount overdue\00")
 (data (i32.const 2512) "refund will not work for internal account\00")
 (data (i32.const 2560) "refund\00")
 (data (i32.const 2576) "account does not exist\00")
 ...
 (func $_ZN5eosio14memory_manager16next_active_heapEv (param $0 i32) (result i32)
  ...
  (block $label$0
   (block $label$1
    (br_if $label$1
     (i32.eqz
      (i32.load8_u offset=11190
       (i32.const 0)
      )
     )
    )
    (set_local $7
     (i32.load offset=11192
      (i32.const 0)
     )
    )
    (br $label$0)
