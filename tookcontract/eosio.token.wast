(module
 ...
 (data (i32.const 1024) "newdexpocket\00")
 (data (i32.const 1040) "You can not transfer to Newdex in a certain period\00")
 (data (i32.const 1104) "whaleextrust\00")
 (data (i32.const 1120) "You can not transfer to this exchange in a certain period\00")
 (data (i32.const 1184) "heydcmjrhege\00")
 (data (i32.const 1200) "eosbtexbonus\00")
 (data (i32.const 1216) "eosconvertbt\00")
 (data (i32.const 1232) "eosbtexteams\00")
 (data (i32.const 1248) "btexexchange\00")
 (data (i32.const 1264) "eosbtextoken\00")
 (data (i32.const 1280) "eosbtexfunds\00")
 (data (i32.const 1296) "locktooktook\00")
 (data (i32.const 1312) "goodtooktook\00")
 (data (i32.const 1328) "From acocunt is locked, ask tooktook admin\00")
 (data (i32.const 1376) "To cocunt is locked, ask tooktook admin\00")
 ...
 (data (i32.const 1888) "lock account does not exist\00")
 (data (i32.const 1920) "lock account already exists in the table\00")
 (data (i32.const 1968) "unlock account does not exist\00")
 (data (i32.const 2000) "there is no matched unlock account in the table\00")
 (data (i32.const 2048) "cannot pass end iterator to erase\00")
 (data (i32.const 2096) "cannot increment end iterator\00")
 (data (i32.const 2128) "account already exist\00")
 (data (i32.const 2160) "\"\"\00")
 (data (i32.const 2176) "account does not exist\00")
 (data (i32.const 2208) "onerror\00")
 (data (i32.const 2224) "eosio\00")
 (data (i32.const 2240) "onerror action\'s are only valid from the \"eosio\" system account\00")
 ...
 (func $_ZN5eosio5token4lockEymNSt3__112basic_stringIcNS1_11char_traitsIcEENS1_9allocatorIcEEEE (type $FUNCSIG$vijii) (param $0 i32) (param $1 i64) (param $2 i32) (param $3 i32)
  ...
  (block $label$0
   (block $label$1
    ...
    (call $_ZZN5eosio11multi_indexILy10164919707266711552ENS_5token11lockup_listEJEE7emplaceIZNS1_4lockEymNSt3__112basic_stringIcNS5_11char_traitsIcEENS5_9allocatorIcEEEEE3$_2EENS3_14const_iteratorEyOT_ENKUlRSE_E_clINS3_4itemEEEDaSG_
     (i32.add
      (get_local $8)
      (i32.const 128)
     )
 ...
 (func $_ZZN5eosio11multi_indexILy10164919707266711552ENS_5token11lockup_listEJEE7emplaceIZNS1_4lockEymNSt3__112basic_stringIcNS5_11char_traitsIcEENS5_9allocatorIcEEEEE3$_2EENS3_14const_iteratorEyOT_ENKUlRSE_E_clINS3_4itemEEEDaSG_ (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i64)
 ...
 (func $_ZN5eosio5token10newaccountEy (type $FUNCSIG$vij) (param $0 i32) (param $1 i64)
  ...
  (block $label$0
   (block $label$1
    ...
    (call $eosio_assert
     (i32.eq
      (i32.load offset=72
       (call $_ZNK5eosio11multi_indexILy14783361125135155200ENS_5token10took_tableEJEE31load_object_by_primary_iteratorEl
        (i32.add
         (get_local $7)
         (i32.const 8)
        )
  ...
  (call $_ZZN5eosio11multi_indexILy14783361125135155200ENS_5token10took_tableEJEE7emplaceIZNS1_10newaccountEyE3$_3EENS3_14const_iteratorEyOT_ENKUlRS7_E_clINS3_4itemEEEDaS9_
   (i32.add
    (get_local $7)
    (i32.const 64)
   )
  ...
  (block $label$2
   ...
   (call $_ZNSt3__16vectorIN5eosio11multi_indexILy14783361125135155200ENS1_5token10took_tableEJEE8item_ptrENS_9allocatorIS6_EEE24__emplace_back_slow_pathIJNS_10unique_ptrINS5_4itemENS_14default_deleteISC_EEEERyRlEEEvDpOT_
    (i32.add
     (get_local $7)
     (i32.const 32)
    )
 ...
 (func $_ZNK5eosio11multi_indexILy14783361125135155200ENS_5token10took_tableEJEE31load_object_by_primary_iteratorEl (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i64)
 ...
 (func $_ZZN5eosio11multi_indexILy14783361125135155200ENS_5token10took_tableEJEE7emplaceIZNS1_10newaccountEyE3$_3EENS3_14const_iteratorEyOT_ENKUlRS7_E_clINS3_4itemEEEDaS9_ (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i64)
 ...
 (func $_ZNSt3__16vectorIN5eosio11multi_indexILy14783361125135155200ENS1_5token10took_tableEJEE8item_ptrENS_9allocatorIS6_EEE24__emplace_back_slow_pathIJNS_10unique_ptrINS5_4itemENS_14default_deleteISC_EEEERyRlEEEvDpOT_ (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
  (local $7 i32)
